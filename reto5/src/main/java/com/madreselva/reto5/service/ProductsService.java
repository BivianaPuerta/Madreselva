...
import com.madreselva.reto5.repository.ProductsRepository;
...
public class ProductsService {
    ...
    public List<Products> productsByPrice(double precio){
        return cosmeticRepository.productsByPrice(precio);
    }
    
    
    public List<Products> findByDescriptionLike(String description) {
	return cosmeticRepository.findByDescriptionLike(description);
    }
